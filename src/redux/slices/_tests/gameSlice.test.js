import gameSlice, {replenishPile} from "../game/gameSlice";

describe("gameSlice action tests", () => {
...
describe("gameSlice reducer tests", () => {
  describe("replenishPile works", () => {
    it("Empty pickup pile, played cards should be put back into deck except last index.", (done) => {
      ...
      const endState = gameSlice(initialState, replenishPile())
